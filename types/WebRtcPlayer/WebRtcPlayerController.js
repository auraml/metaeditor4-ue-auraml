...
import { Flags, ControlSchemeType, TextParameters, OptionParameters } from '../Config/Config';
...
export class WebRtcPlayerController {
    ...
    constructor(config, pixelStreaming) {
        ...
        // custom
        window.metaeditor = {
            emitUIInteraction: (descriptor) => this.sendDescriptorController.emitUIInteraction(descriptor),
            emitCommand: (descriptor) => this.sendDescriptorController.emitCommand(descriptor),
            emitResponse: this.responseController,
        };
        this.sdpConstraints = {
    ...
    registerMessageHandlers() {
        ...
        this.streamMessageController.registerMessageHandler(MessageDirection.ToStreamer, 'LatencyTest', () => this.sendMessageController.sendMessageToStreamer('LatencyTest'));
        ...
        this.streamMessageController.registerMessageHandler(MessageDirection.ToStreamer, 'UIInteraction', (data) => this.sendDescriptorController.emitUIInteraction(data));
        this.streamMessageController.registerMessageHandler(MessageDirection.ToStreamer, 'Command', (data) => this.sendDescriptorController.emitCommand(data));
    ...
    handleStreamerListMessage(messageStreamerList) {
        ...
        if (messageStreamerList.ids.length == 1) {
            ...
            messageStreamerList.ids.includes(urlParams.get(OptionParameters.StreamerId))) {
