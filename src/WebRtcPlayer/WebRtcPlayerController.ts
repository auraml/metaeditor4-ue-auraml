...
export class WebRtcPlayerController {
    ...
    constructor(config: Config, pixelStreaming: PixelStreaming) {
        ...
        // custom
        (window as any).metaeditor = {
            emitUIInteraction: (descriptor: object) => this.sendDescriptorController.emitUIInteraction(descriptor),
            emitCommand: (descriptor: object) => this.sendDescriptorController.emitCommand(descriptor),
